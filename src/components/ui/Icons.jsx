export function ChevronLeftIcon({ size = 18, color = "white", strokeWidth = 2.5 }) {
  return (
...
export function ChevronDownIcon({ size = 12, color = "#86969c" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function MenuIcon({ size = 22, color = "white", strokeWidth = 2.2 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function CloseIcon({ size = 14, color = "currentColor", strokeWidth = 2.5 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function FilterIcon({ size = 18, color = "#0e2c38" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function HeartIcon({ filled = false, size = 22, fillColor = "#DB8B31", strokeColor = "#0e2c38" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={filled ? fillColor : "none"}>
...
export function BookmarkIcon({ filled = false, size = 20, color = "#004D6C", strokeColor = "#0e2c38" }) {
  return (
    <svg width={size} height={Math.round((size * 24) / 20)} viewBox="0 0 24 24" fill={filled ? color : "none"}>
...
export function CommentIcon({ size = 22, color = "#0e2c38" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function PinIcon({ size = 16, color = "#86969c" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function CameraIcon({ size = 40, color = "#DB8B31", strokeWidth = 1.5 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function EyeIcon({ visible = false, size = 20, color = "currentColor" }) {
  if (visible) {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function WarningIcon({ size = 20, color = "#f57c00" }) {
  return (
...
export function PlusIcon({ size = 26, color = "white", strokeWidth = 2.5 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function SendIcon({ size = 24, color = "#DB8B31" }) {
  return (
    <svg width={size} height={size - 3} viewBox="0 0 24 24" fill="none">
...
export function PlayIcon({ size = 30, color = "white" }) {
  return (
